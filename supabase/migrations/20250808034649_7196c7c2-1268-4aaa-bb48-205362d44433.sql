-- Atualizar função create_order_verification_code para registrar eventos de WhatsApp analytics
...
BEGIN
  ...
  -- Criar evento de whatsapp_click para cada produto único
  ...
  -- Criar evento geral de whatsapp_click para o pedido
  INSERT INTO public.customer_events (
    event_type,
    user_id,
    session_id,
