-- Corrigir as funções para adicionar SET search_path
DROP FUNCTION IF EXISTS get_dashboard_analytics(DATE, DATE);
DROP FUNCTION IF EXISTS get_top_products_analytics(DATE, DATE, INTEGER);

-- Função para buscar analytics do dashboard (corrigida)
...
-- Função para buscar analytics dos top produtos (corrigida)
