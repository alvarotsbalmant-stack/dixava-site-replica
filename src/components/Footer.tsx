...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <div className="footer-overflow-container" lang="pt-BR">
        <div className="footer-container">
          <button id="report_button" className="footer-pill footer-pill-secondary" type="button" onClick={toggleModal}>
            Condições e suporte
          </button>
          <a className="footer-pill footer-pill-primary footer-pill-link" target="_blank" href="https://www.canva.com/" aria-label="Criado no Canva">
            <div className="footer-pill-primary-background">
              <svg viewBox="20 20 55 55" xmlns="http://www.w3.org/2000/svg">
                {/* Animation elements and gradients */}
                <defs>
                  <radialGradient id="cyanSpotLarge" cx="0.5" cy="0.5" r="0.5" fx="0.8" fy="0.8" spreadMethod="pad">
                    <stop offset="0%" stopColor="rgb(0, 196, 204)" stopOpacity="1"></stop>
                    <stop offset="100%" stopColor="rgb(0, 196, 204)" stopOpacity="0"></stop>
                  </radialGradient>
                  <radialGradient id="cyanSpot" cx="0.5" cy="0.5" r="0.5" fx="0.2" fy="0.2" spreadMethod="pad">
                    <stop offset="0%" stopColor="rgb(0, 196, 204)" stopOpacity="0.75"></stop>
                    <stop offset="100%" stopColor="rgb(0, 196, 204)" stopOpacity="0"></stop>
                  </radialGradient>
                  <radialGradient id="purpleSpotLarge" cx="0.5" cy="0.5" r="0.5" fx="0.8" fy="0.8" spreadMethod="pad">
                    <stop offset="0%" stopColor="rgb(125, 42, 232)" stopOpacity="1"></stop>
                    <stop offset="100%" stopColor="rgb(125, 42, 232)" stopOpacity="0"></stop>
                  </radialGradient>
                  <radialGradient id="purpleSpot" cx="0.5" cy="0.5" r="0.5" fx="0.2" fy="0.2" spreadMethod="pad">
                    <stop offset="0%" stopColor="rgb(125, 42, 232)" stopOpacity="0.85"></stop>
                    <stop offset="100%" stopColor="rgb(125, 42, 232)" stopOpacity="0"></stop>
                  </radialGradient>
                </defs>
